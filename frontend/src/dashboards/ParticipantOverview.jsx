    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-950">
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
          Browse subevents and register. After registration you will get a QR code; after attendance you can download the certificate.
        </p>
        <div className="mt-3">
          <Link to="/events" className="rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">
            Browse Events
          </Link>
        </div>
      </div>
